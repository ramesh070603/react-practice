    ...
    return (
        <>
            <div className="container">
                <footer className="py-5 px-5 pz-5">
                    <div className="row">
                        <div className="col-2">
                            <h5>Section</h5>
                        ...
                        <div className="col-4 offset-1">
                            <form>
                                ...
                                <div className="d-flex w-100 gap-2">
                                    ...
                                    <input id="newsletter1" type="text" className="form-control" placeholder="Email address" fdprocessedid="en8r7"/>
                                        <button className="btn btn-primary" type="button" fdprocessedid="944549">Subscribe</button>
                                </div>
                            </form>
                        </div>
                    </div>
